...
public class HomeController {
	...
	public List<Employee> loginck(@PathVariable("uname")String uname, @PathVariable("pass")String pass){
		...
		String url="http://zuul/getproduce/login/"+uname+"/"+pass+"";
	...
	public String deletedata(@PathVariable("id")int id){
		...
		String url="http://zuul/getproduce/delete/"+id+"";
		restT.delete(url);
	...
	public Employee editdata(@PathVariable("id")int id) {
		...
		String url="http://zuul/getproduce/editdata/"+id;
	...
	//	String url="http://localhost:8091/up";
		String url="http://zuul/getproduce/up";
		restT.put(url, e);
